...
class Chat extends React.Component {
    ...
    render(){
        const messages = this.props.messages != null ? this.renderMessages(this.state.messages[0].concat(this.props.messages)) : this.renderMessages(this.state.messages[0]);
