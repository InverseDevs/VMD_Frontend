...
class Chat extends React.Component {
    ...
    onScrollBarChange = () => {
      ...
      if (document.getElementById('slider-container').scrollHeight - document.getElementById('slider-container').scrollTop <= document.getElementById('slider-container').clientHeight){
