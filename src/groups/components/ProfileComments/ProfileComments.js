    ...
    sendComment = async (e) => {
       ...
       renderItems(comments){
        ...
        return Object.values(comments).map(comment => {
                return (
                    <ProfileComment name={comment.userData.name} avatar={comment.userData.avatar} commentId={comment.id} setCommentId={this.setCommentId} setSender={this.setSender} innerComments={comment.comments} text={comment.content} key={comment.id} likes={comment.likes} date={comment.sent_time} />
                )
        })};
    }
    render() {
